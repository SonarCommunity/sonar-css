...
public class WhitespaceBetweenPropertyAndValueCheckTest {
  ...
  private WhitespaceBetweenPropertyAndValueCheck check = new WhitespaceBetweenPropertyAndValueCheck();

  @Test
  public void should_raise_issues() {
    SourceFile file = CssAstScanner.scanSingleFile(new File("src/test/resources/checks/whitespaceBetweenPropertyAndValue.css"), check);
